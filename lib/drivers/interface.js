...
exports.defaultConfig = function defaultConfig() {
    return {
        ...
        // this is a special property. It lists properties that
        // are sensitive, and should be masked before passing
        // them to external objects
        // E.g. the 'secret' property should not be provided to
        // reporters, to prevent leaks
        _sensitive: ['secret'],
    };
};
