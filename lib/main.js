...
function main(options) {
    ...
    globals.options.sourceDir = path.resolve(globals.options.sourceDir);
    ...
    // retrieve configurations for the driver
    globals.driverConfig = _.defaultsDeep({},
        globals.options.driverConfig,
        globals.options.driverConfigs[globals.driver.protocol],
        globals.driver.defaultConfig());
    try {
    ...
    const publicConfig = _.cloneDeep(globals.options);
    publicConfig.driverConfig = _.cloneDeep(globals.driverConfig);
    if (_.isFunction(publicConfig.reporter))
        publicConfig.reporter = publicConfig.reporter.name || "(unamed)";
    if (publicConfig.driverConfig._sensitive)
        publicConfig.driverConfig._sensitive.forEach(function(key) {
            publicConfig.driverConfig[key] = hide(publicConfig.driverConfig[key]);
        });
    delete publicConfig.driverConfigs;
    delete publicConfig.driverConfig._sensitive;
